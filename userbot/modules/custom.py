...
from userbot.utils import edit_delete, edit_or_reply, keyy_cmd, reply_id


@keyy_cmd(pattern=r"\#(\S+)")
...
@keyy_cmd(pattern="delcustom(?:\\s|$)([\\s\\S]*)")
async def _(event):
