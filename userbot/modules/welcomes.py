...
@bot.on(keyy_cmd(outgoing=True, pattern=r"setwelcome(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"checkwelcome$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"rmwelcome$"))
