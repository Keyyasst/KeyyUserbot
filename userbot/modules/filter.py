...
from userbot.events import keyy_cmd, register
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"filters$"))
