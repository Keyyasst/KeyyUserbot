...
@bot.on(keyy_cmd(outgoing=True, pattern=r"reserved$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(keyy_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
