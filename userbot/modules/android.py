...
@bot.on(keyy_cmd(outgoing=True, pattern="magisk$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern="pixeldl(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
