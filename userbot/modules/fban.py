...
@bot.on(keyy_cmd(outgoing=True, pattern=r"(d)?fban(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"unfban(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"addf(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"delf$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"listf$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"clearf$"))
