...
@bot.on(keyy_cmd(outgoing=True, pattern=r"notes$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"clear (\w*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"save (\w*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"rmbotnotes (.*)"))
