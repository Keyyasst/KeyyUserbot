...
@bot.on(keyy_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
