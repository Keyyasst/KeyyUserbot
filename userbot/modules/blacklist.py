...
@bot.on(keyy_cmd(outgoing=True, pattern=r"addbl(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"listbl(?: |$)(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"rmbl(?: |$)(.*)"))
