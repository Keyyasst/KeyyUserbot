...
@bot.on(keyy_cmd(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(keyy_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(keyy_cmd(outgoing=True, pattern="whatanime$"))
